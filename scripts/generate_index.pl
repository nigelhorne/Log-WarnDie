...
<html>
	<head>
	<title>Log::WarnDie Coverage Report</title>
	<style>
...
<body>
<div class="badges">
	<a href="https://github.com/nigelhorne/Log-WarnDie">
		<img src="https://img.shields.io/github/stars/nigelhorne/Log-WarnDie?style=social" alt="GitHub stars">
	</a>
	<img src="$coverage_badge_url" alt="Coverage badge">
</div>
<h1>Log::WarnDie</h1><h2>Coverage Report</h2>
...
chomp $commit_sha;
my $github_base = "https://github.com/nigelhorne/Log-WarnDie/blob/$commit_sha/";
...
Readonly my $commit_url => "https://github.com/nigelhorne/Log-WarnDie/commit/$commit_sha";
...
foreach my $file (reverse sort @history_files) {
	...
	my $url = "https://github.com/nigelhorne/Log-WarnDie/commit/$sha";
...
push @html, <<"HTML";
<footer>
	<p>Project: <a href="https://github.com/nigelhorne/Log-WarnDie">Log-WarnDie</a></p>
